                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="text-center p-3">
                                                    ...
                                                    <h6>Total Visits</h6>
                                                    <h4 class="text-success">{{ $contextData['overview']['total_visits'] }}</h4>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="text-center p-3">
                                                    ...
                                                    <h4 class="text-info">{{ $contextData['overview']['active_services_count'] }}</h4>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="text-center p-3">
                                                    ...
                                                    <h4 class="text-warning">{{ $contextData['overview']['active_packages_count'] }}</h4>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="text-center p-3">
                                                    ...
                                                    <h4 class="text-danger">${{ $contextData['overview']['outstanding_balance'] }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        @if($contextData['overview']['last_visit_date'] !== 'No visits')
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="alert alert-info mb-0">
                                                    <i class="fas fa-info-circle me-2"></i>
                                                    <strong>Last Visit:</strong> {{ $contextData['overview']['last_visit_date'] }}
                                                    @if($contextData['overview']['last_visit_type'])
                                                        <span class="badge bg-primary ms-2">{{ ucfirst($contextData['overview']['last_visit_type']) }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
            ...
            <div id="vitals-module" class="module-container">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-sm btn-primary" onclick="refreshVitals()">
                    ...
                    <div class="card-body">
                                ...
                                @foreach($contextData['vitals']['vitals'] as $vital)
                                    <div class="vital-entry">
                                        ...
                                        <div class="vital-metrics">
                                            ...
                                            @if($vital['heart_rate'])
                                                <div class="vital-metric">
                                                    <div class="value">{{ $vital['heart_rate'] }}</div>
                        ...
                        @else
                            <div class="text-center text-muted py-5">
                                ...
                                <h5>No Vitals Recorded</h5>
                                <p>This patient doesn't have any vitals recorded yet.</p>
                                <a href="{{ route('visits.add') }}?patient_code={{ $patient->patient_code }}" class="btn btn-primary">
                                    <i class="fas fa-plus me-2"></i>Add Visit & Vitals
                                </a>
                            </div>
                        @endif
                    </div>
            ...
            <div id="service-results-module" class="module-container">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted">Services from patient visits</small>
                    </div>
                    <div class="card-body">
                        @if($patient->visits->count() > 0)
                            <div class="service-results-timeline">
                                @foreach($patient->visits->sortByDesc('visit_date') as $visit)
                                    @if($visit->services->count() > 0)
                                        <div class="service-result-entry">
                                            <div class="service-date">
                                                <i class="fas fa-calendar-day me-2"></i>
                                                {{ \Carbon\Carbon::parse($visit->visit_date)->format('F d, Y') }}
                                                @if($visit->visit_time)- {{ $visit->visit_time }}@endif
                                                <span class="badge bg-primary ms-2">{{ $visit->visit_code }}</span>
                                            </div>
                                                ...
                                                @foreach($visit->services as $service)
                                                    <div class="service-item">
                                                        <div class="d-flex justify-content-between align-items-start">
                                                            <div>
                                                                <h6 class="mb-1">{{ $service->service->name ?? 'Unknown Service' }}</h6>
                                                                @if($service->notes)
                                                                    <p class="text-muted small mb-1">{{ $service->notes }}</p>
                                                                @endif
                                                                <div class="service-meta">
                                                                    <span class="badge bg-success">Completed</span>
                                                                    @if($service->status)
                                                                        <span class="badge bg-info ms-1">{{ ucfirst($service->status) }}</span>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <div class="text-end">
                        ...
                        @else
                            <div class="text-center text-muted py-5">
                                ...
                                <h5>No Service Results</h5>
                                <p>This patient doesn't have any services recorded yet.</p>
                                <a href="{{ route('visits.add') }}?patient_code={{ $patient->patient_code }}" class="btn btn-primary">
                                    <i class="fas fa-plus me-2"></i>Add Visit & Services
                                </a>
                            </div>
                        @endif
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center text-muted py-5">
                            ...
                            <h5>Coming Soon</h5>
                            <p>Detailed medical history tracking will be available in a future update.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center text-muted py-5">
                            ...
                            <h5>Coming Soon</h5>
                            <p>Prescription management and tracking will be available in a future update.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0">${{ $contextData['billing']['total_billed'] }}</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0">${{ $contextData['billing']['total_paid'] }}</h3>
                                    </div>
                                    <div class="align-self-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="mb-0">${{ $contextData['billing']['outstanding_balance'] }}</h3>
                                    </div>
                                    <div class="align-self-center">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-0">Total Bills</h6>
                                        <h3 class="mb-0">{{ $contextData['billing']['payment_summary']['paid_bills'] + $contextData['billing']['payment_summary']['partial_bills'] + $contextData['billing']['payment_summary']['pending_bills'] }}</h3>
                                    </div>
                                    <div class="align-self-center">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group btn-group-sm">
                            <a href="{{ route('billing.user') }}?patient={{ $patient->patient_code }}" class="btn btn-primary">
                                <i class="fas fa-external-link-alt me-1"></i>View All Bills
                            </a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center text-muted py-5">
                            ...
                            <h5>Coming Soon</h5>
                            <p>Current medication tracking will be available in a future update.</p>
                        </div>
                    </div>
                </div>
            </div>
...
function loadModuleData(moduleName) {
    // Skip API calls for modules that now use real data
    const modulesWithRealData = ['overview', 'vitals', 'service-results', 'billing'];
    
    if (modulesWithRealData.includes(moduleName)) {
        Swal.close();
        return; // Data is already loaded via Blade template
    }
            ...
            <div class="col-12">
                ...
                <div class="border rounded p-3 bg-light">
                    ${result.result_type === 'file' && result.result_file_path ? 
                        `<a href="/storage-public/${result.result_file_path}" target="_blank" class="btn btn-outline-primary btn-sm">
